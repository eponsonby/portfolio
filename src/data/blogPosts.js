export const blogPosts = [
...

  {
    ...
    `As someone who is always learning new things, sometimes I find it helpful to go back to the basics and make sure the bricks holding my house together are not made of cotton candy. Even though that would be delicious mmmm cotton candy house...
      ...
      localhost is a hostname that refers to your own computer. It points to the IP address 127.0.1, which is a special IP address reserved for exactly this purpose.
